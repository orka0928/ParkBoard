import * as Component from "./AttractionModalComponents";
        ...
        <div className="attraction-details">
            ...
            <h4>
                {editComp === "description" ? (
                    ...
                    <>
                        <Component.Text
                            value1={attractionData.description}
                            value2={"description"}
                            setEditComp={setEditComp}
                        />
                    </>
            ...
            <h5>
                {editComp === "review" ? (
                    ...
                    <Component.Text
                        value1={attractionData.review}
                        value2={"review"}
                        setEditComp={setEditComp}
                    />
                )}
            </h5>
            <button type="button" className={`btn-like ${attractionData.like ? "like" : ""}`}>
